...
@section('content')
    ...
    border-bottom: 1px solid #eee;">
        <h1 class="page-title" style="font-weight: 400; color: #38A63A">Tin Doanh Nghiệp</h1>
    </header>

    @foreach($listNewsCompany as $value)
        <div class="post-news" style="border-bottom: 1px solid #e1e1e1;padding-bottom: 20px;margin-bottom: 30px;">

        <div class="entry-thumb">
            <a class="thumb-zoom" href="{{route('detail_news_company',['title' => str_slug($value['title'], '-'),'id' => $value['id']])}}">
        ...
        <div class="entry-content">
            ...
            <a class="vmag-archive-more" href="{{route('detail_news_company',['title' => str_slug($value['title'], '-'),'id' => $value['id']])}}">
                Xem thêm
            </a>
        </div><!-- .entry-content -->
    </div>
    ...
    <div class="pagination-custom">
        <?php echo $listNewsCompany->render(); ?>
    </div>
@endsection